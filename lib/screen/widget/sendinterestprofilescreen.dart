...
class SendInterestProfile extends ConsumerStatefulWidget {
  final List<AcceptedSentArray> accept;
  final List<RejectedSentArray> reject;
  final List<PendingSentArray> pending;
  const SendInterestProfile(
      {super.key,
  ...
  @override
  ConsumerState<SendInterestProfile> createState() =>
      _SendInterestProfileState();
}

class _SendInterestProfileState extends ConsumerState<SendInterestProfile> {
